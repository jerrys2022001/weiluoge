...
<body>
  <header>
    <div class="wrap top">
      <a class="brand" href="/"><img src="/aifind/find-ai.png" alt="Find AI icon" width="103" height="103"><span>VelocAI Blog</span></a>
  ...
  <main>
    <div class="wrap">
      <section class="hero">
        ...
        <p class="meta">Published {escape(human_date)} | Topic: {escape(post.topic)}</p>
