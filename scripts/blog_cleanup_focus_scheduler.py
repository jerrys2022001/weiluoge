...
CORE_KEYWORDS = [
    ...
    "find large videos",
    "remove screenshots",
    "clean whatsapp storage on iphone",
    "whatsapp storage full iphone",
...
LONG_TAIL_KEYWORDS = [
    ...
    "how to clean whatsapp storage on iphone",
    "whatsapp storage full on iphone fix",
    "how to remove whatsapp photos and videos safely",
    "free up whatsapp storage without deleting chats",
    "clear system storage on iphone",
