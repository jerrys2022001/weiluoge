...
LONG_TAIL_KEYWORDS = [
    ...
    "best way to remove duplicate photos safely",
    "find large videos taking up space on iphone",
    "how to sort videos by size on ios",
    "remove screenshots in bulk on iphone",
    "delete old screenshots without losing important images",
    "clean whatsapp media storage on iphone",
    "how to remove whatsapp photos and videos safely",
    "clear system storage on iphone",
    "iphone system data too large fix",
    "daily phone cleanup checklist 20 minutes",
    "ios cleanup routine for low storage",
    "free up iphone storage without deleting everything",
...
ANGLES: list[CleanupAngle] = [
    ...
    CleanupAngle(
        ...
        title="Clean WhatsApp Media Safely: How to Free Space Without Losing Important Chats",
        description="A practical storage cleanup guide for WhatsApp photos, videos, and downloads so you can free space without deleting important conversations.",
        teaser="A safer WhatsApp media cleanup workflow that balances quick storage wins with low deletion risk.",
